...
headers = {"apikey": "c9f2b640-ff55-11eb-a01f-055218eaec09"}  # used zenserp API
...
def bot_will_respond():
    ...
    try:
        answer = requests.get(
            "https://app.zenserp.com/api/v2/search", headers=headers, params=parameters
        )
...
Button = Button(
    ...
    font=("BatmanForeverAlternate", 16),
    command=bot_will_respond,
)
messageWindow = Entry(
    frame1,
    relief=GROOVE,
